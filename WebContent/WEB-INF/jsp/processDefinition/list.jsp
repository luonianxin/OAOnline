...
<div id="MainArea">
        ...
        <tbody id="TableData" class="dataContainer" >
			<s:iterator value="list">
				<tr class="TableDetail1 template">
						...
						<td>${description}&nbsp;</td>
						<td><s:a onClick="return window.confirm('您确定要删除该记录吗？')"  action="processDefinition_delete?key=%{key}" namespace="/" >删除</s:a>
							<a onclick="showProcessImage('${id}')">查看流程图</a>
						</td>
				</tr>
			</s:iterator>
        </tbody>
    ...
    <!-- 其他功能超链接 -->
    <div id="TableTail">
        <div id="TableTail_inside" style="margin-bottom: 12px">
