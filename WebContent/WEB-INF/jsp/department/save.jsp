            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td width="100">上级部门</td>
                        <td>
                            <s:select name="parentId" list="departmentlist" cssClass="SelectStyle" listKey="id" listValue="name" headerKey="" headerValue="请选择部门"></s:select>
                        </td>
                    </tr>
                    <tr><td>部门名称</td>
                        <td><s:textfield name="name" type="text" cssClass="InputStyle"></s:textfield>*</td>
                    </tr>
                    <tr><td>职能说明</td>
                        <td>
                        <s:textarea name="description" class="TextareaStyle"> </s:textarea>
                        </td>
                    </tr>
                </table>
            </div>
